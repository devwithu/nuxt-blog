    ...
    return new Vuex.Store({
        ...
        actions: {
            ...
            initAuth(vuexContext) {
                ...
                const expiratioinDate = localStorage.getItem("tokenExpiration");

                if(new Date().getTime() > +expiratioinDate || !token) {
                    return;
                }
                vuexContext.dispatch('setLogoutTimer', +expiratioinDate - new Date().getTime());
